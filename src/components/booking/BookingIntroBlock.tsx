...
export function BookingIntroBlock() {
  return (
    <section className="section-reveal flex w-full flex-col items-center gap-10 lg:items-start">
      ...
      <div className="flex w-full flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-12">
        <div className="w-full max-w-[468px] shrink-0 lg:size-[468px] lg:max-w-none">
          <Image
            src="/images/booking/intro-salon.webp"
        ...
        <div className="flex w-full max-w-[620px] flex-col items-start gap-6 lg:max-w-[680px] lg:min-w-0">
          ...
          <div className="flex w-full flex-col items-start gap-8 text-neutral-900">
            ...
            <div className="flex w-full flex-col items-start gap-4">
              ...
              <p
                ...
                style={{ fontFeatureSettings: '"liga" 0' }}
              >
                Once identified, users are contacted to complete appointments via
                the Booking Experience. They can log in using methods like email
                or SMS, depending on their status. The goal is to manage all
                situations while ensuring a simple, enjoyable experience,
                improving bookings and reducing drop-off.
              </p>
            </div>
          </div>
        </div>
